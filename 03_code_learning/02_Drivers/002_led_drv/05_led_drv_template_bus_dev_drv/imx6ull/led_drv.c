...
void led_class_device_create(int minor) {
  device_create(led_class, NULL, MKDEV(major, minor), NULL, "majorzpley_led%d",
                minor); /* /dev/100ask_led0,1,... */
}

void led_class_device_destroy(int minor) {
...
EXPORT_SYMBOL(led_class_device_destroy);
...
static int __init led_init(void) {
  ...
  printk("%s %s line %d\n", __FILE__, __FUNCTION__, __LINE__);
  major = register_chrdev(0, "majorzpley_led", &led_drv); /* /dev/led */
